            ...
            <div id="message-frame">
              ...
              <div className="content">
                <div className="settings-form p-4">
                  <h2 className="mb-4">Security &amp; Login</h2>
                  <div className="login-sessions">
                    <h5 className="mb-3 text-muted">Where You're Logged In</h5>
                    <div className="media location-card">
                      <img
                        className="mr-4"
                        src="assets/images/icons/sessions/desktop.png"
                        alt="Generic placeholder image"
                      />
                      <div className="media-body">
                        <h5 className="mt-0 fs-1">
                          Windows PC · Yerevan, Armenia
                        </h5>
                    ...
                    <div className="media location-card">
                      <img
                        className="mr-4"
                        src="assets/images/icons/sessions/android.png"
                        alt="Generic placeholder image"
                      />
                      <div className="media-body">
                        <h5 className="mt-0 fs-1">
                          Android · Yerevan, Armenia
                        </h5>
                    ...
                    <div className="media location-card">
                      <img
                        className="mr-4"
                        src="assets/images/icons/sessions/iphone.png"
                        alt="Generic placeholder image"
                      />
                      <div className="media-body">
                        <h5 className="mt-0 fs-1">iPhone · Gyumri, Armenia</h5>
                        <span className="text-muted">Safari · 14 days ago</span>
                      </div>
                      <div className="dropdown pull-right">
                        <a
                          href="#"
                    ...
                    <div className="media location-card">
                      <img
                        className="mr-4"
                        src="assets/images/icons/sessions/tablet.png"
                        alt="Generic placeholder image"
                      />
                      <div className="media-body">
                        <h5 className="mt-0 fs-1">Tablet · Gyumri, Armenia</h5>
                        <span className="text-muted">
                          Firefox · 2 months ago
                        </span>
                      </div>
                      <div className="dropdown pull-right">
                        <a
                    ...
                    <div className="location-more d-flex justify-content-between">
                      <a href="#">See More</a>
