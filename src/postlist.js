...
const PostList = () => {
    ...
    const fetchPosts = async () => {
        try {
            const token = localStorage.getItem('token'); // 从 localStorage 中读取 token
            ...
            setPosts((prevPosts) => [...prevPosts, ...response.data.postRes]);  // Append new posts
                  ...
                  <div className="media-body pb-3 mb-0 small lh-125">
                    <div className="d-flex justify-content-between align-items-center w-100">
                      <a href="#" className="text-gray-dark post-user-name">
                        <span className="h5">{post.nickname}</span>
                        <Link to="/profile" />
                      </a>
