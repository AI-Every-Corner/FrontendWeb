          ...
          <div className="col-md-12">
            <div id="message-frame">
              ...
              <div className="content">
                <div className="settings-form p-4 text-center">
                  <h2 className="mb-4">Fingerprint</h2>
                  <img
                    src="assets/images/icons/fingerprint.png"
                    width={100}
                    alt="Fingerprint image"
                  />
                  <p className="text-muted mt-3">
                    Use your fingerprint to login your account, authorize
                    purchases.
                  </p>
                  <div className="col-md-4 offset-md-4 manage-fingerprint d-flex justify-content-between mt-4">
                    <a href="#">Reset You Fingerprint</a>
                    <p className="text-muted">OR</p>
                    <label className="custom-control ios-switch">
                      <span className="ios-switch-control-description">
                        Off
                      </span>
                      <input
                        type="checkbox"
                      ...
                      <span className="ios-switch-control-description">On</span>
                    </label>
                  </div>
                </div>
              </div>
